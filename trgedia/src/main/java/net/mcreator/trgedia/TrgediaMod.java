...
@Mod("trgedia")
public class TrgediaMod {
	public static final Logger LOGGER = LogManager.getLogger(TrgediaMod.class);
	public static final String MODID = "trgedia";

	public TrgediaMod(IEventBus modEventBus) {
